...
public class Program {
    public static void main(String[] args) {
        ...
        // Group
        Group group1 = new Group(1, "Group A", 1, new java.util.Date());
        Group group2 = new Group(2, "Group B", 2, new java.util.Date());
        Group group3 = new Group(3, "Group C", 3, new java.util.Date());
        System.out.println("Group 1: " + group1.getGroupName());

        // GroupAccount
        GroupAccount ga1 = new GroupAccount(1, 1, "2024-02-01");
        GroupAccount ga2 = new GroupAccount(2, 2, "2024-02-02");
        GroupAccount ga3 = new GroupAccount(3, 3, "2024-02-03");
        ...
        // Question
        Question q1 = new Question(1, "What is Java?", 1, 1, 1, "2024-03-01");
        Question q2 = new Question(2, "Explain OOP.", 1, 2, 2, "2024-03-02");
        Question q3 = new Question(3, "What is SQL?", 3, 1, 3, "2024-03-03");
        ...
        // Exam
        Exam e1 = new Exam(1, "EX001", "Java Basics", 1, 60, 1, "2024-04-01");
        Exam e2 = new Exam(2, "EX002", ".NET Basics", 2, 60, 2, "2024-04-02");
        Exam e3 = new Exam(3, "EX003", "SQL Basics", 3, 60, 3, "2024-04-03");
        ...
        if (groupsOfAcc2 == null || groupsOfAcc2.length == 0) {
            ...
            for (int i = 0; i < groupsOfAcc2.length; i++) {
                ...
                if (i < groupsOfAcc2.length - 1) System.out.print(", ");
            }
            System.out.println();
        ...
        System.out.println(acc2.getDepartment() == null ? "Nhân viên 2 chưa có phòng ban" : "Phòng ban của nhân viên 2 là " + acc2.getDepartment().getDepartmentName());

        // Question 4: Ternary kiểm tra Position của account thứ 1
        System.out.println(pos1.getPositionName().equalsIgnoreCase("Dev") ? "Đây là Developer" : "Người này không phải là Developer");

        // Question 5: SWITCH CASE - Lấy ra số lượng account trong nhóm thứ 1
        Account[] accountsInGroup1 = {acc1, acc2, acc3}; // Thay đổi số lượng phần tử để test các trường hợp
        int count = accountsInGroup1.length;
        switch (count) {
            case 1:
        ...
        for (Account acc : accounts) {
            System.out.println("Email: " + acc.getEmail() + ", FullName: " + acc.getFullName() + ", Department: " + (acc.getDepartment() != null ? acc.getDepartment().getDepartmentName() : "Không có"));
        }
        ...
        for (int i = 0; i < accounts.length; i++) {
            ...
            System.out.println("Phòng ban: " + (accounts[i].getDepartment() != null ? accounts[i].getDepartment().getDepartmentName() : "Không có"));
        }
        ...
        i = 0;
        while (i < accounts.length) {
            if (accounts[i].getAccountID() >= 4) { i++; continue; }
            System.out.println("Account có id < 4: " + accounts[i].getUserName());
            i++;
        }
