...
import assigment1.Account;
import assigment1.Answer;
import assigment1.CategoryQuestion;
import assigment1.Department;
import assigment1.Exam;
import assigment1.ExamQuestion;
import assigment1.Group;
import assigment1.GroupAccount;
import assigment1.Position;
import assigment1.Question;
import assigment1.TypeQuestion;
...
public class Program {
    public static void main(String[] args) {
        ...
        // Group
        Group group1 = new Group(1, "Group A", acc1, new java.util.Date());
        Group group2 = new Group(2, "Group B", acc2, new java.util.Date());
        Group group3 = new Group(3, "Group C", acc3, new java.util.Date());
